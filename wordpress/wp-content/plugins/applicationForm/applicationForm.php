...
Description: Form to save the data of the applicants
...
/*
add_action('admin_menu','applicationForm_admin_actions');

function applicationForm_admin_actions(){
	add_options_page('applicationForm','applicationForm','manage_options',_FILE_,'applicationForm_admin');
...
*/
register_activation_hook(__FILE__,'applicationForm'); 


//function applicationForm_admin(){
